...
set CommonLinkerFlags=-opt:ref user32.lib gdi32.lib winmm.lib dsound.lib
...
cl %CommonCompilerFlags% ..\src\game.cpp -Fmgame.map -LD /link -incremental:no -EXPORT:GameUpdateAndRender -PDB:game_%date:~10,4%%date:~4,2%%date:~7,2%_%timestring:~0,2%%timestring:~3,2%%timestring:~6,2%.pdb
